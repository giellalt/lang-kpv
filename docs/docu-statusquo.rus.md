...
[морфологическом анализаторе Коми](http://giellatekno.uit.no/cgi/index.kom.eng.html)  
и [его исходных файлах](https://gtsvn.uit.no/langtech/trunk/kt/kom/src/).

## 15 июля 2016

Статус для [исходных файлов](https://gtsvn.uit.no/langtech/trunk/langs/kpv/src/):
...
1. Интеграция коми-русского словаря в морфологический анализатор (ОК)
1. Добавить больше слов:
    1. Проверять анализатор на текстовом материале, 
   а также добавлять новые слова
    1. Систематически добавлять русские заимствования: имена собственные 
   и технические термины (ОК)
1. Работа по орфографии
