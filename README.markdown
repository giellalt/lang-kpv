...
This directory contains source files for the Komi-Zyrian language
...
-   <https://giellalt.uit.no/lang/kpv/index.html> (analyser)
...
The Komi-Zyrian language sources can be acquired using [giella SVN
