...
echo $sentence | tokenize bin/tok.fst | 
$LOOKUP -flags mbTT -utf8 ~/gtsvn/kt/kom/bin/kom.fst | ~/gtsvn/gt/script/lookup2cg | \
 vislcg3 -g ~/gtsvn/kt/kom/src/kom-dis.rle --trace  # no m4
#dis.sh --grammar ~/kt/kom/bin/kom-dis.rle --minimal  # m4
